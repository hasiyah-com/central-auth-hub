...
//               สรุปเหตุการณ์ (Incident Summary)
//             </h3>
...
//             {/* ① Entry */}
//             <Card title="1. ช่องทางการเข้า (Authentication Entry)">
...
//             <Card title="2. การวิเคราะห์ความเสี่ยง (Risk Analysis)">
...
//             {/* ③ Reasons (Evidence) */}
//             <Card title="3. หลักฐานความเสี่ยง (Evidence · Risk Reasons)">
//               {reasons.length ? (
...
//             <Card title="4. ไทม์ไลน์เหตุการณ์ (Timeline)">
//               {timeline.length ? (
...
//             {/* ⑤ System Response */}
//             <Card title="5. การตอบสนองของระบบ (System Response)">
//               <KV
//                 label="Decision"
//                 value={
//                   <Badge tone={DECISION_TONE[system_response.decision || ""] || "default"}>
...
//             <Card title="6. แนวทางการจัดการ (Recommended Actions)">
...
//             {/* ⑦ Additional Info */}
//             <Card title="7. ข้อมูลเพิ่มเติม (Additional Info · 7 วัน)" span={2}>
...
//             {/* ⑧ Related Links */}
//             <Card title="8. ลิงก์ที่เกี่ยวข้อง">
//               <div className="space-y-2">
...
export function IncidentDetailModal({ data, onClose, onActionDone }: Props) {
  ...
  return (
    <div className={`${styles.detailOverlay} fixed inset-0 z-50 bg-ink-900/50 overflow-y-auto p-4`} role="dialog" aria-modal="true" aria-labelledby="incident-detail-title">
      {verifying && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl px-6 py-5 shadow-xl flex items-center gap-3 text-sm">
            กำลังยืนยันด้วย Passkey…
      ...
      <div className={`${styles.detailDialog} mx-auto max-w-6xl bg-ink-50 rounded-2xl shadow-2xl overflow-hidden`}>
        {/* ── header ── */}
        <div className="bg-white px-6 py-4 border-b border-ink-200 flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-3">
            <h1 id="incident-detail-title" className="text-xl font-extrabold text-ink-900">รายละเอียดเหตุการณ์เสี่ยง</h1>
            <Badge tone={lvl.tone}>{lvl.label}</Badge>
          </div>
          <button onClick={onClose} aria-label="ปิดรายละเอียดเหตุการณ์" className="text-ink-400 hover:text-ink-700 text-2xl leading-none">
            ×
          </button>
        </div>
