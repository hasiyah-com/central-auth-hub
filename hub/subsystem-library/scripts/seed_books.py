...
BOOKS = [
    ...
    ("9780321125217", "Domain-Driven Design", "Eric Evans", "คอมพิวเตอร์", 2, None),
    (
        "9780132350884",
        "Clean Code",
        "Robert C. Martin",
    ...
    ("9789747528947", "ไทยศึกษา: บทความรวมเล่ม", "หลายผู้แต่ง", "มนุษยศาสตร์", 2, None),
    # บริหารธุรกิจ
    (
        "9780062735225",
        "Good to Great",
    ...
    ("9780062060242", "The Lean Startup", "Eric Ries", "บริหารธุรกิจ", 3, None),
    (
        "9780670921607",
    ...
    ("9780062273833", "Zero to One", "Peter Thiel", "บริหารธุรกิจ", 3, None),
