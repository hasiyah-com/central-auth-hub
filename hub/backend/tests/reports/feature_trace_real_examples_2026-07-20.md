...
ผู้ใช้ `U08@example.invalid` กดล็อกอินผ่าน Google เข้า "ระบบหอพัก" เวลา 2026-07-20 15:25:
...
user         : U08@example.invalid (student, คณะวิศวกรรมศาสตร์)
subsystem    : ระบบหอพัก
...
ผู้ใช้ `U01@example.invalid` (admin) login เวลา 2026-07-20 15:07 — **จากเครื่องใหม่**:
```
created_at   : 2026-07-20 15:07:11
user         : U01@example.invalid (admin)
os / browser : Windows 10 / Chrome 150.0.0.0    device_type : desktop
login_method : google
