...
**สร้างเมื่อ:** 2026-08-28 · **ช่วงข้อมูล:** ทั้งหมด · **สร้างโดย:** `scripts/l3_shadow_replay.py`
...
| **effective** — L3 ทำให้ decision เปลี่ยน | 0 | — |
...
| การตรวจ | ผล |
|---|---|
| session ที่ L3 เปลี่ยน decision เป็นอย่างอื่นนอกจาก warn | **0** ✅ |
...
|---|---|---|
| diagnostic | 0.2 ปี (61 วัน) | 0.0 ปี (11 วัน) |
| warn | 1.7 ปี (607 วัน) | 0.3 ปี (105 วัน) |
| challenge | 3.3 ปี (1214 วัน) | 0.6 ปี (210 วัน) |
