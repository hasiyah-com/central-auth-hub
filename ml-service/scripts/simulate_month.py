...
def main():
    ...
    for email in ["U08@example.invalid", "U04@example.invalid"]:
        u = U(email)
    ...
    for email in ["U06@example.invalid", "U08@example.invalid"]:
        u = U(email)
        sub, role = home[email][1][0]
    ...
    for email in ["U08@example.invalid", "U01@example.invalid"]:
        u = U(email)
        sub, role = home[email][1][0]
